...
export const AnimatedScrollProgress: React.FC<IScrollProgress> &
  ...
  ({
    ...
    fabHeight = 50,
    fabBottomOffset = 30,
    fabBackgroundColor: fabBackgroundColorProp,
    fabEndBackgroundColor: fabEndBackgroundColorProp,
    fabBorderRadius = radius.full,
    ...
    const fabBackgroundColor = fabBackgroundColorProp ?? colors.primary;
    const fabEndBackgroundColor = fabEndBackgroundColorProp ?? colors["accent-user"];
