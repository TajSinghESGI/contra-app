...
import { radius, type ColorTokens } from "@/constants/tokens";
...
const BottomSheetComponent = forwardRef<BottomSheetMethods, BottomSheetProps>(
  (
    ...
    const backgroundColor = backgroundColorProp ?? colors["surface-container-lowest"];
...
export type { BottomSheetMethods, BottomSheetProps, SnapPoint } from "./types";
