...
export type { AnimatedProgressBarProps } from "./types";
...
export const AnimatedProgressBar: React.FC<AnimatedProgressBarProps> = ({
  ...
  const trackColor = trackColorProp ?? colors["surface-container-high"];
  const gradientColors = gradientColorsProp ?? [colors.primary, colors["accent-user"]];
