...
import { fonts, radius, spacing, shadows, type ColorTokens } from "@/constants/tokens";
  ...
  const animatedStyle = useAnimatedStyle(() => {
    ...
    return {
      ...
      backgroundColor: withTiming(
        isActive ? (colors["surface-container-low"] as string) : "transparent",
        { duration: 120 },
      ),
    };
  });
...
const createStyles = (colors: ColorTokens) =>
  StyleSheet.create<Styles>({
    ...
    content: {
      ...
      padding: spacing[2],
      shadowColor: shadows.float.shadowColor,
      shadowOffset: shadows.float.shadowOffset,
      shadowOpacity: shadows.float.shadowOpacity,
      shadowRadius: shadows.float.shadowRadius,
      elevation: shadows.float.elevation,
    },
    item: {
      flexDirection: "row",
      alignItems: "center",
