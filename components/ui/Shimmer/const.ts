...
import type { IShimmerColorTheme, ShimmerPreset } from "./types";

const getShimmerPresets = (colors: ColorTokens): Record<ShimmerPreset, IShimmerColorTheme> => ({
  contra: {
    colors: [
