...
import type { IShimmerEffect, IShimmerGroup } from "./types";
import { getShimmerPresets } from "./const";
...
export const ShimmerEffect: React.FC<IShimmerEffect> &
  ...
  ({
    ...
    const shimmerPresets = useMemo(() => getShimmerPresets(colors), [colors]);
    ...
    const themeColors =
      preset === "custom" && shimmerColors
        ? shimmerColors
        : shimmerPresets[preset].colors;

    const backgroundColor =
      preset !== "custom" ? shimmerPresets[preset].backgroundColor : undefined;
