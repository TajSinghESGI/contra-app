...
const DEFAULT_TOAST_OPTIONS_BASE: Omit<Required<ToastOptions>, "backgroundColor"> = {
  duration: 3000,
  type: "default",
  position: "bottom",
  onClose: () => {},
...
export const ToastProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const defaultToastOptions = useMemo<Required<ToastOptions>>(
    () => ({
      ...DEFAULT_TOAST_OPTIONS_BASE,
